...
##################################
authorList = ["Suzanne Collins","James S.A. Corey","C.S. Lewis","Andrzej Sapkowski","Ravi Subramanian","Nicholas Eames","Andy Weir","Robert Jordan","George R. R. Martin","Stephen King","Brandon Sanderson","John Green","Amish Tripathi","J.K. Rowling"]
bookDict={"Suzanne Collins" : ["The Hunger Games","Catching Fire","Mockingjay"],"James S.A. Corey" : ["Leviathan Wakes","Caliban's War","Abaddon's Gate","Cibola Burn","Babylon's Ashes","Nemesis Games"],"Andy Weir" : ["The Martian","Artemis","The Egg"],"C.S. Lewis" : ["The Lion, the Witch and the Wardrobe","The Voyage of the Dawn Treader","The Magician's Nephew","The Last Battle","The Great Divorce","The Screwtape Letters"],"Andrzej Sapkowski" : ["The Last Wish","Blood of Elves"],"Ravi Subramanian" : ["If God was a Banker","The Incredible Banker","God is a Gamer","The Bestseller She Wrote","I Bought the Monks Ferrari"],"Nicholas Eames" : ["Kings of the Wyld","Bloody Rose"],"Robert Jordan" : ["The Eye of the World","The Great Hunt","The Dragon Reborn","The Shadow Rising","The Fires of Heaven","Lord of Chaos"],"J.K. Rowling" : ["the Sorcerer's Stone","the Prisoner of Azkaban","the Chamber of Secrets","the Goblet of Fire","the Order of the Phoenix","the Half-Blood Prince","The Tales of Beedle the Bard"],"George R. R. Martin":["A Game of Thrones","A Clash of Kings","A Storm of Swords","A Feast for Crows","A Dance with Dragons","Fevre Dream","The Ice Dragon"],"Stephen King":["The Shining","It","The Gunslinger","Pet Sematary","The Dark Tower","The Stand","The Outsider"],"Brandon Sanderson":["The Final Empire","The Way of Kings","The Well of Ascension","The Hero of Ages","Elantris","Words of Radiance","The Alloy of Law","Steelheart","Oathbringer","The Bands of Mourning","Shadows of Self"],"John Green" : ["The Fault in Our Stars","Looking for Alaska","Paper Towns","Turtles All the Way Down"],"Amish Tripathi":["The Immortals of Meluha","The Secret of the Nagas","The Oath of the Vayuputras","Scion of Ikshvaku","Sita: Warrior of Mithila"]}
